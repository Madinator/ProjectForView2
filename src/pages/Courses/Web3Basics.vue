    ...
    <div class="page page-course page-creative-training">
        <div class="animation-block">
            ...
            <CustomHeader
                ...
                description='Earn.Games will help students learn the basics of Web 3.0 - a phenomenon that processes information through Machine Learning and Artificial Intelligence without relying on external oracles. This course is perfect for Students, Practitioners, Trainers, etc.'
                pageName='Web3Basics'
            ></CustomHeader>
            <SectionCards
                titleLine1='Web 3.0'
...
.page-creative-training {
    ...
    ::v-deep(.section-buy .info),
    ::v-deep(.section-cards .info) {
