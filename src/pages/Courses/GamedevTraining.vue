    ...
    <div class="page page-course page-creative-training">
        <div class="animation-block">
            ...
            <CustomHeader
                ...
                :slotsAll='990'
                :slotsAvailable='990'
                title='Gamedev training'
                description='By being eligible for the course, the candidates will learn a comprehensive game development language where students can also create gaming projects for their portfolios.'
                pageName='GamedevTraining'
            ></CustomHeader>
            <SectionCards
                titleLine1='Gamedev'
                titleLine2='training'
