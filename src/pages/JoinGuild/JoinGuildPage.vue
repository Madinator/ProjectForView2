...
// SET CURRENT JOIN GUILD PAGE ON LOAD
...
// CHANGE CURRENT JOIN GUILD PAGE
    ...
    <div class="page page-joinGuild">
        <div class="inner-container">
            <div class="page-joinGuild__header">
                ...
                <h1 class="page-joinGuild__header__title">Apply to join guild</h1>
                <span class="page-joinGuild__header__text">Follow the simple 4 steps to join guild</span>
            </div>
